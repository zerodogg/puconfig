...
or relative to the directory that puconfig.yml lives in.
...
override this. To override it, you can "return", which will skip the file (and
thus a scriptBefore block can function as a condition, if you want it to).
